 <footer id="footer">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 footer-contact">
          <h4>Kontak Kami</h4>
          <p>Jl. Raya Kapin Kp. baru, Pondok Kelapa, Duren Sawit, Jakarta Timur<br>
            <strong>Telepon :</strong> (021) 22845597<br>
  ...
  <div class="container">
    <div class="copyright">
      &copy; Copyright <strong>Masjid Jami' Nurussalam</strong> Jakarta Timur
    </div>
<!--     <div class="credits">
